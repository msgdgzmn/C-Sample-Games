...
go:
 ...
 for ( int stage; stage <= 1 ; stage++){
 	
 	cin>>diffi;
 	if(diffi=='N'||diffi=='n'||diffi=='h'||diffi=='H'||diffi=='e'||diffi=='E'){
 	...
 	else if ((diffi != 'N') && (diffi != 'H') && (diffi != 'E') ){
 		cout<<"\n\t INVALID!"<<endl<<"\nTry Again!\t";
...
/*
cout<<"You Lose and your score is : ";

for( int highscore; highscore<= pts; highscore++){
	highscore=pts;
	cout<<pts<<endl ;
}
*/
